...
root_agent_openai = Agent(
    name="hello_assistant_openai",
    model=LiteLlm(model="openai/gpt-4o"),
    description="A friendly AI assistant powered by OpenAI GPT-4o",
    instruction=(
...
root_agent_claude = Agent(
    name="hello_assistant_claude",
    model=LiteLlm(model="anthropic/claude-3-5-sonnet-20241022"),
    description="A friendly AI assistant powered by Anthropic Claude",
    instruction=(
        "You are a warm and helpful assistant equipped with weather query and calculator tools. "
        "When users ask about weather, use the get_weather tool to provide accurate information. "
        "When users need calculations, use the calculator tool to solve mathematical expressions. "
...
root_agent_claude_haiku = Agent(
    name="hello_assistant_claude_haiku",
    model=LiteLlm(model="anthropic/claude-3-haiku-20240307"),
    description="A friendly AI assistant powered by Anthropic Claude Haiku (fast and cost-effective)",
    instruction=(
        "You are a warm and helpful assistant equipped with weather query and calculator tools. "
        "When users ask about weather, use the get_weather tool to provide accurate information. "
        "When users need calculations, use the calculator tool to solve mathematical expressions. "
