  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="none"
      />
      <circle cx="6" cy="18" r="2" fill={`url(#${gradientId})`} opacity="0.8" />
      <circle cx="12" cy="20" r="1.5" fill={`url(#${gradientId})`} opacity="0.6" />
      <circle cx="18" cy="17" r="2.5" fill={`url(#${gradientId})`} opacity="0.7" />
    </svg>
  );
};
